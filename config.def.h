...
static const int showsystray        = 10;     /* 0 means no systray */
...
static const char *fonts[]          = { "UbuntuMono Nerd Font Mono:size=12", "Symbola:size=10" };
...
static Key keys[] = {
	...
	{ MODKEY,			                  XK_y,      spawn,		       SHCMD("scrot -s $HOME/Pictures/screenshots/%Y-%m-%d-%T-screenshot.png") },
